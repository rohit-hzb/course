          ...
          {loading ? (
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
              {courses.map((course) => (
                ...
                >
                  <img
                    src={course.image?.url ||"https://images.unsplash.com/photo-1516116412344-6663387e8590?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8amF2YXNjcmlwdCUyMGNvZGV8ZW58MHx8MHx8fDA%3D"}
                    alt={course.title}
